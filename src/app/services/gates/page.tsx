                    ...
                    <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                        <div>
                            ...
                            <div className="space-y-6 text-slate-600 leading-relaxed">
                                <p>
                                    Whether you need a side entrance gate for security or a decorative garden gate, our custom aluminum solutions are the perfect choice.
                                </p>
                                <p>
                                    We use heavy-duty hinges and lockable latches to ensure your gate is secure. And because it's aluminum, it will never rust, sag, or warp like wood or steel gates often do.
                                </p>
                            </div>
                            <div className="mt-8">
