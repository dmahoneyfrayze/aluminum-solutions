...
export default function PoolFencesContent() {
    return (
                ...
                <section className="py-20 bg-slate-50">
                    <div className="container mx-auto px-6">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                            ...
                            <div className="aspect-square relative rounded-lg overflow-hidden">
                                <Image src="/images/generated/railing_hero_detail_1764312850877.webp" alt="Deck railings" fill className="object-cover hover:scale-110 transition-transform duration-500" />
                            </div>
                        </div>
                    </div>
                </section>
